...
static rosidl_typesupport_introspection_c__MessageMember my_robot_interfaces__msg__HardwareStatus__rosidl_typesupport_introspection_c__HardwareStatus_message_member_array[4] = {
  {
    "version",  // name
    ...
    offsetof(my_robot_interfaces__msg__HardwareStatus, version),  // bytes offset in struct
    NULL,  // default value
