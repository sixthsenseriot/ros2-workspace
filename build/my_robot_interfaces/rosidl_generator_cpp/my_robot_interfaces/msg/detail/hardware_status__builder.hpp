...
{
public:
  explicit Init_HardwareStatus_temperature(::my_robot_interfaces::msg::HardwareStatus & msg)
  : msg_(msg)
  {}
...
public:
  ...
  {}
  Init_HardwareStatus_temperature version(::my_robot_interfaces::msg::HardwareStatus::_version_type arg)
  {
...
{
  return my_robot_interfaces::msg::builder::Init_HardwareStatus_version();
}
